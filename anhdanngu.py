...
def an():
    ...
    try:
        ...
        print logo
        time.sleep(1)
        print 'Ket ban voi toi tren facebook !!'
        time.sleep(3)
        print 'vui long ket ban...!!'
        time.sleep(3)
        ...
        if uname == taikhoan:
            ...
            if pwd == matkhau:
                ...
                raw_input('\x1b[32;1m[\x1b[31;1m+\x1b[32;1m]\x1b[37;1m nhan enter de dang nhap ')
                os.system('reset')
                an()
        else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				zedd.close()
				print '\n\033[1;91m[\033[1;96m✓\033[1;91m] \033[1;92mdang nhap thanh cong'
		...
		if 'checkpoint' in url:
			print("\n\033[1;91m[!] \033[1;93mTai khoan bi Checkpoint")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;91m[!] Dang nhap that bai")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	print "\033[1;97m╚"+40*"═"
	print "1]. Thong tin nguoi dung"
	print "2]. Hack tai khoan Facebook               "
	print "3]. Hien thi token           "
	print "4]. Dang xuat            "
	print "5]. Thoat           "
	pilih()
#-
